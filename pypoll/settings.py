...
# SECRET_KEY = '*8*d89=gqa8%hn71(i4o-c2a6y3vwke7)(++9#trm+_r^i@eyc'
...
STATIC_ROOT = os.path.join(os.path.join(os.path.abspath(__file__)), 'staticfiles')
STATIC_URL = '/static/'
